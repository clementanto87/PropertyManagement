...
import { Calendar as CalendarIcon, Users, CheckCircle2, Loader2, X } from 'lucide-react';
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        {amenities.length === 0 ? (
                            ...
                            amenities.map((amenity) => (
                                ...
                                >
                                    <Card
                                        className={`overflow-hidden cursor-pointer transition-all hover:shadow-lg ${selectedAmenity === amenity.id
                                            ...
                                            {getDateOptions().map((date) => {
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        disabled={isDatePast}
                                                        className={`p-3 rounded-lg text-center text-sm font-medium transition-all ${isSelected
                                            ...
                                            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-2">
                                                {timeSlots.map((time) => (
                                                    <button
                                                        ...
                                                        className={`px-3 py-2.5 rounded-lg text-sm font-medium border-2 transition-all ${selectedTime === time
                                ...
                                myBookings.map((booking) => {
                                    ...
                                    return (
                                        <motion.div
                                            ...
                                            className={`flex items-start gap-3 p-4 rounded-lg border transition-all ${isUpcoming
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="mt-2 flex items-center">
                                                    <span className={`inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium ${booking.status === 'CONFIRMED'
